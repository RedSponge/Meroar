...
# GUIDELINES += "- Prompt Rule: Point out recurring behaviour \n"
# GUIDELINES += "    * Once the conversation reaches a problematic behaviour, check whether you know it is a recurring one from past events.\n"
# GUIDELINES += "    * Ask the correspondent whether they recognize the problematic behaviours\n"
...
# GUIDELINES += "- Prompt rule for pattern detection:"
GUIDELINES += "    - When discussing a partner's abusive behaviour, ask the correspondent if they've encountered this behaviour before. "
